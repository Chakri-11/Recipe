...
{
    return (
        <div className="overflow-y-auto bg-gray-100 md:col-span-2 md:bg-gradient-to-tr ">
            <h1 className="hidden md:flex justify-center text-4xl font-semibold text-orange-500">
                <a href="https://www.amazon.in/">FOOD FEST</a>
            </h1>
            <main className="px-20 py-5 bg-gray-100 bg-gradient-to-br from-orange-100 via-yellow-100 to-red-100">
